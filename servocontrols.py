...
# Pi 5 hardware PWM via RP1 chip (chip=2)
# Channel 0 = GPIO 12, Channel 1 = GPIO 13
# Channel 2 = GPIO 18, Channel 3 = GPIO 19
eyeslr = HardwarePWM(pwm_channel=0, hz=SERVO_HZ, chip=2)  # GPIO 12 - eyes l/r
eyesud = HardwarePWM(pwm_channel=1, hz=SERVO_HZ, chip=2)  # GPIO 13 - eyes up/down
jaw = HardwarePWM(pwm_channel=2, hz=SERVO_HZ, chip=2)     # GPIO 18 - jaw
necklr = HardwarePWM(pwm_channel=3, hz=SERVO_HZ, chip=2)  # GPIO 19 - neck l/r
